...
public class RefereeStub {
    ...
    public void getGamesForSeasonTest(){
        ...
        g.add(g11);
        g.add(g2);
        assertEquals(g11.getId(),rTest1.getGamesForSeason(new Season(2019,g)).get(0).getId());
        assertEquals(g2.getId(),rTest1.getGamesForSeason(new Season(2019,g)).get(1).getId());
        assertEquals(g00.getId(),rTest1.getGamesForSeason(new Season(2019,g)).get(2).getId());
        assertEquals(g3.getId(),rTest1.getGamesForSeason(new Season(2019,g)).get(3).getId());
    }
}
